...
#Region "Constructors (Singleton Pattern)"
    ...
    'Public Shared Function GetInstance() As FormattedHMS
    ...
    '    Friend Shared ReadOnly INSTANCE As FormattedHMS = New FormattedHMS
    'End Class
#End Region
