...
#Region "Constructors (Singleton Pattern)"
    ...
    'Public Shared Function GetInstance() As LX200LongHr
    ...
    '    Friend Shared ReadOnly INSTANCE As LX200LongHr = New LX200LongHr
    'End Class
#End Region
