...
#Region "Public and Friend Members"
    ...
    Public Accel As Double
    Public BegVel As Double
    Public EndVel As Double
#End Region
...
#Region "Constructors (Singleton Pattern)"
    ...
    'Public Shared Function GetInstance() As MotionVector
    ...
    '    Friend Shared ReadOnly INSTANCE As MotionVector = New MotionVector
    'End Class
#End Region
