...
Public Class DegreeSliderRenderer
...
#Region "Constructors (Singleton Pattern)"
    ...
    'Public Shared Function GetInstance() As DegreeSliderRenderer
    ...
    '    Friend Shared ReadOnly INSTANCE As DegreeSliderRenderer = New DegreeSliderRenderer
    'End Class
#End Region
...
#Region "Constructors"
    Protected Sub New()
        ...
        pIGaugeValue.MaxValue = Units.OneRev
        pNumMarks = 8
    ...
    Public Shared Function GetInstance() As DegreeSliderRenderer
        Return New DegreeSliderRenderer
    End Function
#End Region
