...
Public Class ScopePilotAnalyzeFieldRotationAngleRenderer
...
#Region "Inner Classes"
    Private Class dataModel
        ...
        Public FieldRotationAngleRad As Double
        ...
        Public Sub New(ByVal RaRad As Double, ByVal decRad As Double, ByRef pointData As PointData, ByVal trackingRate As Double)
            ...
            Me.FieldRotationAngleRad = trackingRate
        End Sub
        Public Overrides Function ToString() As String
            Return RaRad * Units.RadToDeg & " " & DecRad * Units.RadToDeg & " " & FieldRotationAngleRad * Units.RadToArcsec
        End Function
    End Class
#End Region
...
#Region "Constructors (Singleton Pattern)"
    ...
    '    Public Shared Function GetInstance() As ScopePilotAnalyzeFieldRotationAngleRenderer
    ...
    '        Friend Shared ReadOnly INSTANCE As ScopePilotAnalyzeFieldRotationAngleRenderer = New ScopePilotAnalyzeFieldRotationAngleRenderer
    '    End Class
#End Region
...
#Region "Constructors"
    ...
    Public Shared Function GetInstance() As ScopePilotAnalyzeFieldRotationAngleRenderer
        Return New ScopePilotAnalyzeFieldRotationAngleRenderer
    End Function
#End Region
...
#Region "Private and Protected Methods"
    ...
    Private Sub processPoint(ByRef pointData As PointData)
        ...
        Dim trackingRate As Double = getFieldRotationAngle(RaRad, DecRad)
        calcPoint(pointData)
    ...
    Private Function getFieldRotationAngle(ByVal RaRad As Double, ByVal DecRad As Double) As Double
        Return CDbl(pCalculator.DynamicInvoke(New Object() {RaRad, DecRad}))
    End Function
    ...
    Private Sub drawDataModels()
        For Each dataModel As dataModel In pDataModels
            ...
            Dim colorPoint As Int32 = eMath.RInt(dataModel.FieldRotationAngleRad / Units.OneRev * 511)
