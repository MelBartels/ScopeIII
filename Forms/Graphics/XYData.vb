...
#Region "Constructors (Singleton Pattern)"
    ...
    'Public Shared Function GetInstance() As XYData
    ...
    '    Friend Shared ReadOnly INSTANCE As XYData = New XYData
    'End Class
#End Region
...
#Region "Private and Protected Methods"
    Private Sub defaults()
        pDataColor = Drawing.Color.Blue
        pGridColor = Drawing.Color.LightGray
        pBackgroundColor = Drawing.Color.White
        pAxisColor = Drawing.Color.Black
        pTextColor = Drawing.Color.Gray
        pAxisFont = New Drawing.Font("Arial", 8)
        pPenWidth = 2
        pDrawMode = DrawModeType.Line
        pBorderTop = 30
        pBorderLeft = 50
        pBorderBottom = 50
        pBorderRight = 30
