...
#Region "Private and Protected Methods"
    Protected Overrides Sub init()
        ...
        AxisCoordGaugePresenter.GetInstance.Build(CType(pUserCtrlGauge2AxisCoordZ12Presenter, IGauge2AxisCoordPresenter), CoordName.Z1, CoordName.Z2)
        ...
        AxisCoordGaugePresenter.GetInstance.Build(CType(pUserCtrlGauge2AxisCoordLatAzPresenter, IGauge2AxisCoordPresenter), CoordName.Latitude, CoordName.Az)
