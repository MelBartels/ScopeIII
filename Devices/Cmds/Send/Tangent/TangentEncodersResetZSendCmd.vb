...
Public Class TangentEncodersResetZSendCmd
...
#Region "Constructors (Singleton Pattern)"
    ...
    'Public Shared Function GetInstance() As TangentEncodersResetZSendCmd
    ...
    '    Friend Shared ReadOnly INSTANCE As TangentEncodersResetZSendCmd = New TangentEncodersResetZSendCmd
    'End Class
#End Region
...
#Region "Constructors"
    ...
    Public Shared Function GetInstance() As TangentEncodersResetZSendCmd
        Return New TangentEncodersResetZSendCmd
    End Function
#End Region
...
#Region "Public and Friend Methods"
    Public Overrides Function CreateXmtBytes() As Byte()
        ...
        sb.Append(BartelsLibrary.Constants.Plus)
