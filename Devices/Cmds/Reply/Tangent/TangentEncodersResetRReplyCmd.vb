...
Public Class TangentEncodersResetRReplyCmd
...
#Region "Constructors (Singleton Pattern)"
    ...
    'Public Shared Function GetInstance() As TangentEncodersResetRReplyCmd
    ...
    '    Friend Shared ReadOnly INSTANCE As TangentEncodersResetRReplyCmd = New TangentEncodersResetRReplyCmd
    'End Class
#End Region
...
#Region "Constructors"
    ...
    Public Shared Function GetInstance() As TangentEncodersResetRReplyCmd
        Return New TangentEncodersResetRReplyCmd
    End Function
#End Region
...
#Region "Public and Friend Methods"
    Public Overrides Function ReplyAction(ByRef IDevice As IDevice, ByRef IIO As IIO, ByRef cmd As String, ByRef cmdMsg As String) As Boolean
        ...
        ' a valid Reset command (R20000<tab>20000<return>) in hex looks like:
        ' "x52 x32 x30 x30 x30 x30 x9 x32 x30 x30 x30 x30 xD "
