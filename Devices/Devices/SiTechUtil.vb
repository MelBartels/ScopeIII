...
#Region "Shared Methods"
    ...
    Public Shared Function IsPrimaryController(ByVal IDevice As IDevice) As Boolean
        Return CByte(IDevice.GetValueObject(ValueObjectNames.ModuleAddress.Name).Value) <= 1
    End Function

    Public Shared Sub BuildDeviceNames(ByVal IDevice As IDevice)
        If IsPrimaryController(IDevice) Then
