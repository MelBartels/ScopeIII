...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        UserCtrlGauge2AxisCoordZ12.GaugeLayout = ScopeIII.Common.Layout.Vertical
        UserCtrlGauge2AxisCoordLatAz.GaugeLayout = ScopeIII.Common.Layout.Vertical
    ...
    Friend WithEvents MvpUserCtrlGraphics As ScopeIII.Common.MVPUserCtrlGraphics
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.MvpUserCtrlGraphics = New ScopeIII.Common.MVPUserCtrlGraphics
        ...
        'MvpUserCtrlGraphics
        '
        Me.MvpUserCtrlGraphics.IMVPUserCtrlPresenter = Nothing
        ...
        Me.UserCtrlGauge2AxisCoordZ12.IMVPUserCtrlPresenter = Nothing
        ...
        Me.UserCtrlGauge2AxisCoordLatAz.IMVPUserCtrlPresenter = Nothing
...
#End Region
    ...
    Public Overrides Function DefaultPresenter() As IMVPPresenter
        Return initDefaultPresenter(CompareZ12Presenter.GetInstance)
    End Function
    ...
    Public Sub SetToolTip()
        ToolTip.SetToolTip(MvpUserCtrlGraphics, eString.GraphicsToolTip)
    ...
    Protected Overridable Sub resizer(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.SizeChanged
        ...
        Dim UserCtrlGauge2AxisCoordHeight As Int32 = CInt((MyBase.Height - PropertyGrid.Height) * 0.3)
        UserCtrlGauge2AxisCoordZ12.Size = New Size(UserCtrlGauge2AxisCoordWidth, UserCtrlGauge2AxisCoordHeight)
        UserCtrlGauge2AxisCoordZ12.Location = New Point(PropertyGrid.Location.X, PropertyGrid.Height + 16)
        ...
        UserCtrlGauge2AxisCoordLatAz.Size = New Size(UserCtrlGauge2AxisCoordLatAzWidth, UserCtrlGauge2AxisCoordLatAzHeight)
        UserCtrlGauge2AxisCoordLatAz.Location = New Point(UserCtrlGauge2AxisCoordZ12.Location.X, UserCtrlGauge2AxisCoordZ12.Location.Y + UserCtrlGauge2AxisCoordZ12.Height)
