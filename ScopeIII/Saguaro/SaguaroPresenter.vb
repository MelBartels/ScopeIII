...
#Region "Private and Protected Methods"
    Protected Overrides Sub init()
        ...
        frmSaguaro.txBxEpochFrom.Text = CStr(Settings.GetInstance.SaguaroEpoch)
        frmSaguaro.txBxEpochTo.Text = Settings.GetInstance.DatafilesEpoch
    End Sub
    ...
    Private Sub readFile(ByVal filename As String)
        Dim eMath As eMath = Common.eMath.GetInstance
        Dim settings As Settings = Common.Settings.GetInstance
        ...
        While line IsNot Nothing
            ...
            If columnNames Is Nothing Then
                ...
                Dim advPredicate As ActionPredicateWrapper(Of String, Object) = _
                        New ActionPredicateWrapper(Of String, Object)(AddressOf displayColumn, New columnIx)
                Array.ForEach(columnNames, AddressOf advPredicate.Action)
            Else
                ...
                Dim advPredicate As ActionPredicateWrapper(Of Int32, Object) = _
                        New ActionPredicateWrapper(Of Int32, Object)(AddressOf appendStringToSB, New Object() {dataRowString, sb})
                Array.ForEach(SaguaroObjectNameSequence, AddressOf advPredicate.Action)
    ...
    Private Sub displayColumn(ByVal [string] As String, ByVal columnIx As Object)
        Debug.WriteLine(CType(columnIx, columnIx).Ix & ": " & [string])
    ...
    Private Sub writeFile(ByVal filename As String)
        ...
        Dim advPredicate As ActionPredicateWrapper(Of Object, writeParms) = _
                New ActionPredicateWrapper(Of Object, writeParms)(AddressOf writeObject, writeParms)
        Array.ForEach(pData.ToArray, AddressOf advPredicate.Action)
