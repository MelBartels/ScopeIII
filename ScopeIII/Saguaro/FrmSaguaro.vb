...
#End Region
    ...
    Public Overrides Function DefaultPresenter() As IMVPPresenter
        Return initDefaultPresenter(SaguaroPresenter.GetInstance)
    End Function

    Public Event LoadFile()
    Public Event SaveFile()

    Private Delegate Sub delegateBindingSource(ByVal value As Object)
    Private Delegate Sub delegateSetEpochFromText(ByVal value As String)
    Private Delegate Sub delegateSetEpochToText(ByVal value As String)
    ...
    Public Function EpochDeltaYr() As Double
        Return CType(EpochToText, Double) - CType(EpochFromText, Double)
    End Function
    ...
    Private Sub setDataFilesDataSource(ByVal value As Object)
        If DataGridView1.InvokeRequired Then
            DataGridView1.Invoke(New delegateBindingSource(AddressOf setDataFilesDataSource), New Object() {value})
        Else
    ...
    Private Sub setEpochFromText(ByVal value As String)
        If txBxEpochFrom.InvokeRequired Then
            txBxEpochFrom.Invoke(New delegateSetEpochFromText(AddressOf setEpochFromText), New Object() {value})
        Else
    ...
    Private Sub setEpochToText(ByVal value As String)
        If txBxEpochTo.InvokeRequired Then
            txBxEpochTo.Invoke(New delegateSetEpochToText(AddressOf setEpochToText), New Object() {value})
        Else
