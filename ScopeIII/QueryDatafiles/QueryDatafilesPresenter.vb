...
#Region "Private and Protected Members"
    ...
    Private pProgressMediator As ScopeIII.Forms.ProgressMediator
#End Region
...
#Region "Private and Protected Methods"
    ...
    Private Sub save()
        pProgressMediator.ProcessStartup(New ProgressMediator.CallbackDelegate(AddressOf saveCallback))
    End Sub
