...
#Region "Private and Protected Methods"
    Protected Overrides Sub work()
        Dim queryDatafilesPresenter As QueryDatafilesPresenter = ScopeIII.QueryDatafilesPresenter.GetInstance
        queryDatafilesPresenter.IMVPView = New FrmQueryDatafiles
        queryDatafilesPresenter.ShowDialog()
    End Sub
#End Region
