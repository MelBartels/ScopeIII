...
#Region "Private and Protected Methods"
    Protected Overrides Sub init()
        ...
        AddHandler FrmTestScopeIII.DataFileConverter, AddressOf MainDataFileConverter.GetInstance.Main
        AddHandler FrmTestScopeIII.PrecessDatafiles, AddressOf MainPrecessDatafiles.GetInstance.Main
        AddHandler FrmTestScopeIII.CelestialErrors, AddressOf MainCelestialErrors.GetInstance.Main
        ...
        AddHandler FrmTestScopeIII.ArcGauge, AddressOf MainArcGaugeOK.GetInstance.Main
        AddHandler FrmTestScopeIII.RenderScalarGauges, AddressOf MainRenderScalarGaugesOK.GetInstance.Main
        AddHandler FrmTestScopeIII.RenderCoordGauges, AddressOf MainRenderCoordGaugesOK.GetInstance.Main
        ...
        AddHandler FrmTestScopeIII.Encoder, AddressOf MainEncoder.GetInstance.Main
        AddHandler FrmTestScopeIII.EncodersBoxSim, AddressOf MainEncodersBoxSim.GetInstance.Main
        AddHandler FrmTestScopeIII.EncodersBoxCtrl, AddressOf MaintEncodersBoxCtrl.GetInstance.Main
        AddHandler FrmTestScopeIII.JRKerrExample, AddressOf MainJRKerrExample.GetInstance.Main
        AddHandler FrmTestScopeIII.JRKerrUtility, AddressOf MainJRKerrUtility.GetInstance.Main
    End Sub
