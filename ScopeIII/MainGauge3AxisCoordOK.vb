...
#Region "Private and Protected Methods"
    Protected Overrides Sub work()
        ...
        Dim frmThreadObsPri As Threading.Thread = New Threading.Thread(AddressOf observerFormPri)
        frmThreadObsPri.Start()
        Dim frmThreadObsSec As Threading.Thread = New Threading.Thread(AddressOf observerFormSec)
        frmThreadObsSec.Start()
        Dim frmThreadObsTier As Threading.Thread = New Threading.Thread(AddressOf observerFormTier)
    ...
    Protected Sub gaugeForm()
        ...
        pGauge3AxisCoordOKPresenter.IGauge3AxisCoordPresenter.SetAxisNames("Primary", "Secondary", "Tiertiary")
        addToConnect(4)
    ...
    Protected Sub observerFormPri()
        ...
        pCoordinateObserverPresenterPri.UserCtrlCoordPresenter.SetCoordinateName("Primary")
        addToConnect(4)
    ...
    Protected Sub observerFormSec()
        ...
        pCoordinateObserverPresenterSec.UserCtrlCoordPresenter.SetCoordinateName("Secondary")
        addToConnect(4)
    ...
    Protected Sub observerFormTier()
        ...
        pCoordinateObserverPresenterTier.UserCtrlCoordPresenter.SetCoordinateName("Tiertiary")
        addToConnect(4)
