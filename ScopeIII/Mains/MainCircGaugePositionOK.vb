...
#Region "Private and Protected Methods"
    Protected Overrides Sub work()
        ...
        Dim frmThreadObsRA As New Threading.Thread(AddressOf observerFormRA)
        frmThreadObsRA.Start()
        Dim frmThreadObsDec As New Threading.Thread(AddressOf observerFormDec)
        frmThreadObsDec.Start()
        Dim frmThreadObsAz As New Threading.Thread(AddressOf observerFormAz)
        frmThreadObsAz.Start()
        Dim frmThreadObsAlt As New Threading.Thread(AddressOf observerFormAlt)
        frmThreadObsAlt.Start()
        Dim frmThreadObsSidT As New Threading.Thread(AddressOf observerFormSidT)
